...
const timelineEvents: TimelineEvent[] = [
    {
        time: "3:00 PM",
        event: "The Ceremony",
        description: "The official union of Josh & Pat.",
        icon: Heart,
        hueA: 40,
        hueB: 40,
    },
    {
        time: "5:30 PM",
        event: "Registration & Cocktails",
        description: "Registration and Cocktail Hour.",
        icon: Wine,
        hueA: 40,
        hueB: 40,
    },
    {
        time: "6:00 PM",
        event: "Reception",
        description: "Join us for a celebration of love.",
        icon: Sparkles,
        hueA: 40,
        hueB: 40,
    },
    {
        time: "7:00 PM",
        event: "Dinner & Cake Cutting",
        description: "Feast and celebration.",
        icon: Utensils,
        hueA: 40,
        hueB: 40,
    },
    {
        time: "8:00 PM",
        event: "Speeches & Dances",
        description: "Heartfelt moments and celebration.",
        icon: Music,
        hueA: 40,
        hueB: 40,
    },
    {
        time: "9:00 PM",
        event: "Send Off",
        description: "A final farewell as we start our journey.",
        icon: PartyPopper,
        hueA: 40,
        hueB: 40,
    },
